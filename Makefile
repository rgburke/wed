...
SOURCES=wed.c display.c buffer.c util.c input.c session.c status.c command.c file.c value.c list.c hashmap.c config.c encoding.c config_parse_util.c config_parse.c config_scan.c gap_buffer.c buffer_pos.c text_search.c regex_search.c search.c replace.c
OBJECTS=$(SOURCES:.c=.o)
